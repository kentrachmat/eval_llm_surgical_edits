...
<a href="https://github.com/ktgiahieu/eval_llm_surgical_edits/raw/master/PAPER.pdf" style="display: inline-block; padding: 20px 40px; font-size: 24px; font-weight: bold; text-decoration: none; color: white; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 15px; box-shadow: 0 8px 16px rgba(0,0,0,0.2); transition: transform 0.2s, box-shadow 0.2s;">
📄 Download Paper (PDF)
</a>
